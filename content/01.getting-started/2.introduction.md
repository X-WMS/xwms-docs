...
> → Visit the [Partner Dashboard](/partner/client-setup)  
> → Check out the [OAuth Setup](/partner/client-oauth) for integration instructions
...
- [Server Setup & Security](/partner/server/setup)  
- [GitHub Deployment](/partner/server/github)  
- [MySQL Setup & Access](/partner/server/mysql)  
- [File Permissions](/partner/server/filepermissions)  
- [Domain Management & HTTPS](/partner/server/domainmanagment)

---

**Need help or support?** Visit our [Support Page](https://github.com/X-WMS/xwms-docs/discussions) for assistance.
